const granthitemquery = {
    ...
    AddGranthItem: `INSERT INTO public."granth_items" ("title", "description", "image", "link", "granth_id", "author", "year") VALUES ($1,$2,$3,$4,$5,$6,$7) RETURNING *`,
    UpdateGranthItem: `UPDATE public."granth_items" SET "title" = $1, "description" = $2, "image" = $3, "link" = $4, "granth_id" = $5, "author" = $6, "year" = $7 WHERE "_id"= $8  RETURNING *;`,
