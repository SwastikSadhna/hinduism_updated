const bookquery = {
    ...
    AddBook: `INSERT INTO public."books" ("title", "description", "link", "author", "image", "cover_image", "keyword", "year") VALUES ($1, $2, $3, $4, $5, $6, $7, $8)`,
    UpdateBook: `UPDATE public."books" SET "title" = $2, "description" = $3, "link" = $4, "author" = $5, "image" = $6, "cover_image" = $7, "keyword" = $8, "year" = $9 WHERE "id" = $1`,
