  ...
  return (
    <section className=" px-4 py-16 md:py-24">
      <div className="mx-auto max-w-6xl text-center">
        <h2 className="mb-4 text-4xl font-medium md:text-5xl bg-gradient-to-r from-[#FF7722] to-[#FFD700] text-transparent bg-clip-text">
          Daily Hindu Prayer Rituals
        </h2>
        <p className="mx-auto mb-12 max-w-3xl text-black">
        ...
        <div className="grid gap-6 md:grid-cols-3">
          ...
          <div className="rounded-3xl p-6 hover:shadow-lg border-2 border-[#E6D9CC]">
            <div className="flex gap-3">
              <div className="rounded-lg bg-white p-2">
                <svg className="h-8 w-8 text-[#FF7722]" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <button className="mt-4 rounded-tl-2xl rounded-br-2xl bg-[#FF7722] px-10 py-3 text-sm font-medium text-white transition-colors hover:bg-[#E65C00] focus:outline-none focus:ring-2 focus:ring-[#6C5CE7] focus:ring-offset-2">
